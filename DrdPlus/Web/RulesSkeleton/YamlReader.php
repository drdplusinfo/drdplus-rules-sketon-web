...
class YamlReader extends StrictObject implements \ArrayAccess
{
    ...
    /**
     * @return array
     * @throws \DrdPlus\Web\RulesSkeleton\Exceptions\CanNotReadYamlFile
     * @throws \DrdPlus\Web\RulesSkeleton\Exceptions\CanNotParseYamlFile
     */
     ...
     * @param mixed $offset
     * @param mixed $value
     * @throws \DrdPlus\Web\RulesSkeleton\Exceptions\YamlObjectContentIsReadOnly
     */
